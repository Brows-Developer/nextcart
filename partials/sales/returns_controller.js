...
angular.module('Return', ['ui.bootstrap']).controller('ReturnsControllers', function (Page, $scope, $location, $http, $rootScope, $uibModal, $window, $uibModalStack, $filter, $route) { 
