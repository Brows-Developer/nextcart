...
angular.module('Attribute', ['ui.bootstrap']).controller('AttributesControllers', function (Page, $scope, $location, $http, $rootScope, $uibModal, $window, $uibModalStack, $filter, $route) { 
